...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Widget _buildButton(BuildContext context, {required String text, required String icon, required VoidCallback onTap}) {
    return Container(
      height: 56,
      width: double.infinity,
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(
                    ...
                    height: 24, 
                    width: 24,
                    // If asset not found, show nothing or icon? 
                    // User asked for "Google Logo", assuming assets exist or handled.
                    // Adding errorBuilder to avoid crash/ugly box
                    errorBuilder: (context, error, stackTrace) {
                      // Fallback icon based on text if needed, or just empty
